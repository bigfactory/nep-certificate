...
set country=ZH
set state=Guangdong
set locality=Shenzhen
set organization=alibaba.com
set organizationalunit=IT
set email=xiaocong.hxc@alibaba-inc.com
set password=a
...
openssl x509 -req -days 3650 -in %domain%.csr -CA %caPrefix%.crt -CAkey %caPrefix%.key -CAcreateserial -out %domain%.crt
echo Finished
